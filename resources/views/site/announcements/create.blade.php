...
<body style="min-height:100vh;">
    ...
    <main style="max-width:700px;margin:0 auto;padding:6rem 2rem 4rem;">
        ...
        <form method="POST" action="{{ route($rp.'store') }}" novalidate class="gutter-form" style="background:var(--pin-white);border:var(--border);border-radius:12px;padding:2rem;box-shadow:var(--shadow-md);">
            @csrf
            ...
            <div class="gutter-field" style="margin-bottom:1.5rem;">
                ...
                <div class="inp-wrap">
                    <textarea class="input" name="body" rows="5" required>{{ old('body') }}</textarea>
                    <span class="gutter-flag">&#10003;</span>
                </div>
            ...
            <div style="display:flex;gap:1rem;">
                <button type="submit" class="submit">Create Announcement &rarr;</button>
