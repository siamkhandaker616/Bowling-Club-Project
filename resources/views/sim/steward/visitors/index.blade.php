        ...
        <div style="padding:1.25rem;overflow:hidden;">
            ...
            <div style="background:var(--sky-light);border:2px solid var(--navy);border-radius:10px;overflow:hidden;">
                @forelse ($visitors as $visitor)
                    <div style="display:flex;justify-content:space-between;padding:10px 12px;{{ !$loop->last ? 'border-bottom:1px solid var(--fog);' : '' }}align-items:center;">
                        <div style="display:flex;align-items:center;gap:10px;">
                            ...
                            <div>
                                ...
                                <div style="font-family:var(--font-mono);font-size:0.55rem;color:var(--slate);">{{ $visitor->bookings_count }} visits</div>
                            </div>
                        </div>
