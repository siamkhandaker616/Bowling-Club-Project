    ...
    $dock = [
        ...
        'customer' => [
            ...
            'links' => [
                ...
                ['num' => '02', 'label' => 'My Bookings',   'route' => 'visitor.bookings.index'],
                ['num' => '03', 'label' => 'My Scores',     'route' => 'game.leaderboard'],
                ['num' => '04', 'label' => 'Snack Bar',     'route' => 'site.snackbar'],
                ['num' => '05', 'label' => 'Facility Map',  'route' => 'site.facility-map'],
                ['num' => '06', 'label' => 'Events',        'route' => 'public.events'],
                ['num' => '07', 'label' => 'Fixtures',      'route' => 'public.fixtures'],
                ['num' => '08', 'label' => 'Touring',       'route' => 'public.touring'],
                ['num' => '09', 'label' => 'Stats',         'route' => 'public.stats'],
                ['num' => '10', 'label' => 'Pro Shop',      'route' => 'public.proshop.index'],
                ['num' => '11', 'label' => 'Queue',         'route' => 'visitor.queues.index'],
                ['num' => '12', 'label' => 'Reviews',       'route' => 'visitor.reviews.index'],
                ['num' => '13', 'label' => 'Complaints',    'route' => 'visitor.complaints.index'],
            ],
