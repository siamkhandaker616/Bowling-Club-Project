<x-app-layout>
    ...
    <div class="mod-grid" style="min-height:calc(100vh - 200px);">
        ...
        <div style="padding:1.25rem;overflow:hidden;">
            <form method="POST" action="{{ route('manager.inventory.store') }}" class="gutter-form" style="max-width:560px;">
                @csrf
                ...
                <div style="display:grid;grid-template-columns:2fr 1fr;gap:12px;">
                    ...
                    <div class="gutter-field field">
                        ...
                        <input id="category" name="category" class="input" type="text" value="{{ old('category') }}">
                ...
                <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:12px;">
                    ...
                    <div class="gutter-field field">
                        ...
                        <input id="max_quantity" name="max_quantity" class="input" type="number" min="1" data-stepper="edit" value="{{ old('max_quantity', 50) }}">
                        <div class="gutter-err">Min 1 required</div>
                        <div class="gutter-flag">&#10003;</div>
                    </div>
                    <div class="gutter-field field">
                        <label class="label" for="reorder_threshold">Restock Level <span class="req">*</span></label>
                        <input id="reorder_threshold" name="reorder_threshold" class="input" type="number" min="0" data-stepper="edit" value="{{ old('reorder_threshold', 10) }}">
