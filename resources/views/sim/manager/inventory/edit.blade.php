            ...
            <form method="POST" action="{{ route('manager.inventory.update', $inventory) }}" style="background:var(--sky-light);border:2px solid var(--navy);border-radius:12px;padding:1.25rem;display:grid;gap:14px;max-width:560px;">
                ...
                <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:12px;">
                    <div>
                        ...
                        <input id="quantity" name="quantity" type="number" min="0" required value="{{ old('quantity', $inventory->quantity) }}" style="width:100%;font-family:var(--font-body);font-size:0.85rem;padding:8px 12px;border:2px solid var(--navy);border-radius:8px;background:var(--pin-white);">
                    </div>
                    <div>
                        ...
                        <input id="max_quantity" name="max_quantity" type="number" min="1" required value="{{ old('max_quantity', $inventory->max_quantity) }}" style="width:100%;font-family:var(--font-body);font-size:0.85rem;padding:8px 12px;border:2px solid var(--navy);border-radius:8px;background:var(--pin-white);">
                    </div>
                    <div>
                        ...
                        <input id="reorder_threshold" name="reorder_threshold" type="number" min="0" required value="{{ old('reorder_threshold', $inventory->reorder_threshold) }}" style="width:100%;font-family:var(--font-body);font-size:0.85rem;padding:8px 12px;border:2px solid var(--navy);border-radius:8px;background:var(--pin-white);">
                    </div>
                    <div>
                        ...
                        <input id="cost_per_unit" name="cost_per_unit" type="number" step="0.01" min="0" required value="{{ old('cost_per_unit', $inventory->cost_per_unit) }}" style="width:100%;font-family:var(--font-body);font-size:0.85rem;padding:8px 12px;border:2px solid var(--navy);border-radius:8px;background:var(--pin-white);">
                    </div>
                </div>
